...
public class PluginMapGoogle extends PluginMap implements OnMarkerClickListener,
      ...
      if (controls.has("myLocationButton") || controls.has("myLocation")) {
        ...
        if (!locationPermission) {
          ...
          synchronized (semaphore) {
            cordova.requestPermissions(PluginMapGoogle.this, callbackContext.hashCode(), new String[]{
    ...
    if (params.has("camera")) {
      ...
      if (camera.has("target")) {
        ...
        if ("org.json.JSONArray".equals(targetClass.getName())) {
          ...
          initCameraBounds = PluginUtilGoogle.JSONArray2LatLngBounds(points);
          ...
          public void onMapReady(GoogleMap googleMap) {
            ...
            dummyMyLocationButton.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                PluginMapGoogle.this.onMyLocationButtonClick();
              }
            });
            ...
            try {
              ...
              if (params.has("preferences")) {
                ...
                if (preferences.has("gestureBounds")) {
                  ...
                  if ("org.json.JSONArray".equals(targetClass.getName())) {
                    ...
                    LatLngBounds bounds = PluginUtilGoogle.JSONArray2LatLngBounds(points);
              ...
              // Set event listener
              map.setOnCameraIdleListener(PluginMapGoogle.this);
              map.setOnCameraMoveCanceledListener(PluginMapGoogle.this);
              map.setOnCameraMoveListener(PluginMapGoogle.this);
              map.setOnCameraMoveStartedListener(PluginMapGoogle.this);
              map.setOnMapClickListener(PluginMapGoogle.this);
              map.setOnMapLongClickListener(PluginMapGoogle.this);
              map.setOnMarkerClickListener(PluginMapGoogle.this);
              map.setOnMarkerDragListener(PluginMapGoogle.this);
              map.setOnMyLocationButtonClickListener(PluginMapGoogle.this);
              map.setOnMapLoadedCallback(PluginMapGoogle.this);
              map.setOnIndoorStateChangeListener(PluginMapGoogle.this);
              map.setOnInfoWindowClickListener(PluginMapGoogle.this);
              map.setOnInfoWindowLongClickListener(PluginMapGoogle.this);
              map.setOnInfoWindowCloseListener(PluginMapGoogle.this);
              map.setOnMyLocationClickListener(PluginMapGoogle.this);
              map.setOnPoiClickListener(PluginMapGoogle.this);

              //Custom info window
              map.setInfoWindowAdapter(PluginMapGoogle.this);
              ...
              if (args.length() == 3) {
                ...
                mapCtrl.mPluginLayout.addPluginOverlay(PluginMapGoogle.this);
                PluginMapGoogle.this.resizeMap(args, new PluginUtil.MyCallbackContext("dummy-" + map.hashCode(), webView) {
                  @Override
                    ...
                    if (initCameraBounds != null) {
                      map.setOnCameraIdleListener(new GoogleMap.OnCameraIdleListener() {
                        ...
                        public void onCameraIdle() {
                          ...
                          PluginMapGoogle.this.onCameraIdle();
                          map.setOnCameraIdleListener(PluginMapGoogle.this);
                      ...
                      PluginMapGoogle.this.onCameraEvent("camera_move_end");
                ...
                if (initCameraBounds != null) {
                  ...
                  //if (map.getMapType() == GoogleMap.MAP_TYPE_NONE) {
                    PluginMapGoogle.this.onMapLoaded();
                  //}
                }
              }
            } catch (Exception e) {
  ...
  public synchronized void loadPlugin(final JSONArray args, final CallbackContext callbackContext) throws JSONException {
    ...
    try {
      ...
      ((MyPluginInterface)plugin).setPluginMap(PluginMapGoogle.this);
  ...
  public void create(final JSONArray args, final CallbackContext callbackContext) throws JSONException {
    ...
    try {
      ...
      pluginMap = PluginMapGoogle.this;
  ...
  public void setDiv(JSONArray args, CallbackContext callbackContext) throws JSONException {
    if (args.length() == 0) {
      PluginMapGoogle.this.mapDivId = null;
      mapCtrl.mPluginLayout.removePluginOverlay(mapId);
      callbackContext.success();
      return;
    }
    PluginMapGoogle.this.mapDivId = args.getString(0);
    mapCtrl.mPluginLayout.addPluginOverlay(PluginMapGoogle.this);
  ...
  public void remove(JSONArray args, final CallbackContext callbackContext) {
    ...
    try {
      PluginMapGoogle.this.clear(null, new PluginUtil.MyCallbackContext(mapId + "_remove", webView) {
        ...
        public void onResult(PluginResult pluginResult) {
          cordova.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
              ...
              PluginMapGoogle.this.onDestroy();
            }
          });
        }
      });
    ...
    try {
      ...
      if (params.has("camera")) {
        ...
        if (camera.has("target")) {
          ...
          if ("org.json.JSONArray".equals(targetClass.getName())) {
            JSONArray points = camera.getJSONArray("target");
            cameraBounds = PluginUtilGoogle.JSONArray2LatLngBounds(points);
              ...
              if (controls.has("myLocation") || controls.has("myLocationButton")) {
                cordova.getThreadPool().submit(new Runnable() {
                  ...
                  public void run() {
                    ...
                    args.put(controls);
                    try {
                      PluginMapGoogle.this.setMyLocationEnabled(args, callbackContext);
                    } catch (JSONException e) {
                      e.printStackTrace();
    ...
    if (tilt > 0 && tilt <= 90) {
      ...
      this.activity.runOnUiThread(new Runnable() {
        ...
        public void run() {
          ...
          CameraPosition newPosition = new Builder()
  ...
  private class UpdateCameraAction extends AsyncTask<Void, Void, AsyncUpdateCameraPositionResult> {
    ...
    UpdateCameraAction(CallbackContext callbackContext, JSONObject cameraPos, Builder builder, String action) {
      super();
    ...
    protected AsyncUpdateCameraPositionResult doInBackground(Void... voids) {
      ...
      try {
        ...
        if ("org.json.JSONArray".equals(targetClass.getName())) {
          ...
          result.cameraBounds = PluginUtilGoogle.JSONArray2LatLngBounds(points);
