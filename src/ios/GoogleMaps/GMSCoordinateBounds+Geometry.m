...
@implementation MAPointAnnotation (MFAdditions)

ASSOCIATED(userData, setUserData, id, OBJC_ASSOCIATION_ASSIGN)
ASSOCIATED(map, setMap, MAMapView *, OBJC_ASSOCIATION_ASSIGN)
ASSOCIATED(layer, setLayer, GMSMarkerLayer *, OBJC_ASSOCIATION_ASSIGN)
ASSOCIATED(snippet, setSnippet, NSString *, OBJC_ASSOCIATION_ASSIGN)
ASSOCIATED(icon, setIcon, UIImage *, OBJC_ASSOCIATION_ASSIGN)

@end

@implementation MACircle (MFAdditions)

ASSOCIATED(map, setMap, MAMapView *, OBJC_ASSOCIATION_ASSIGN)

@end

@implementation MAPolyline (MFAdditions)

ASSOCIATED(map, setMap, MAMapView *, OBJC_ASSOCIATION_ASSIGN)

@end

@implementation MAPolygon (MFAdditions)

ASSOCIATED(map, setMap, MAMapView *, OBJC_ASSOCIATION_ASSIGN)

@end

@implementation MATileOverlay (MFAdditions)

ASSOCIATED(map, setMap, MAMapView *, OBJC_ASSOCIATION_ASSIGN)

@end

@implementation MAGroundOverlay (MFAdditions)
...
- (void)setZIndex:(int)val {
    objc_setAssociatedObject(self, @selector(zIndex), [NSNumber numberWithInt:(val)], OBJC_ASSOCIATION_ASSIGN);
}
